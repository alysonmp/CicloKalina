...
public class ModelEthylbenzeneLiquido implements Serializable{
    ...
    public ModelEthylbenzeneLiquido(double pressao, double temperatura, double kl, double Cpl, double Prl, double Mul, double Vcl) {
    ...
    public ModelEthylbenzeneLiquido(double pressao, double temperatura) {
        this.pressao = pressao;
        this.temperatura = temperatura;
    }
