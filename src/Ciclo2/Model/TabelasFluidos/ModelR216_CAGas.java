...
public class ModelR216_CAGas implements Serializable{
    ...
    public ModelR216_CAGas(double pressao, double temperatura, double kv, double Cpv, double Prv, double Muv, double Vcv) {
    ...
    public ModelR216_CAGas(double pressao, double temperatura) {
        this.pressao = pressao;
        this.temperatura = temperatura;
    }
