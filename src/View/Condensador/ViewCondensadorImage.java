    ...
    public ViewCondensadorImage(ControlPrincipal ctrlPrincipal){
        ...
        this.addMouseListener(new MouseListener() {
            ...
            public void mouseEntered(MouseEvent e) {
                int x = e.getX();
                int y = e.getY();
                ctrlResposta = new ControlCaixaResposta(x, y, ctrlPrincipal.getSession(), "condensador");
                ctrlResposta.getViewCaixa().getFrameCaixa().setBounds(ViewCondensadorImage.this.getLocationOnScreen().x+ViewCondensadorImage.this.getWidth(), ViewCondensadorImage.this.getLocationOnScreen().y-ViewCondensadorImage.this.getHeight(), 250, 125);
            }
