...
public class ControlFugmix {
    ...
    double bpi, bpj, cpi, cpj, vml, vmv, 
    ...
    public ControlFugmix(double T, double P, double zi){
        ...
        ap_4j = ((2*zi*constantes.getaj())+(zi*(Math.pow((constantes.getai()*constantes.getaj()),0.5))) * (1-constantesMix.getKji()+1-constantesMix.getKij()+((constantesMix.getKij() - constantesMix.getKji())*zi)));
        ...
        QQ = (Math.pow(constantesMix.getbm(),2)+(6*constantesMix.getbm()*Math.pow(constantesMix.getcm(),2))*(-1));
        ...
        F1v_j = (((vmv/(QQ*DD_v))*(Math.pow(constantesMix.getbm(),2)+Math.pow(constantesMix.getcm(),2)+(6*constantesMix.getbm()*constantesMix.getcm())+(bpj*constantesMix.getbm())+(3*bpj*constantesMix.getcm())+(3*constantesMix.getbm()*cpj)+(constantesMix.getcm()*cpj)))
                ...
                + ((D1_v/QQ)*(constantesMix.getbm()*bpj)+(3*constantesMix.getbm()*cpi)- (Math.pow(constantesMix.getbm(),2)) + (3*bpj*constantesMix.getcm())+(constantesMix.getcm()*cpj)-(Math.pow(constantesMix.getcm(),2))-(6*constantesMix.getbm()*constantesMix.getcm())));
        ...
        F1l_j = (((vml/(QQ*DD_l))*(Math.pow(constantesMix.getbm(),2)+Math.pow(constantesMix.getcm(),2)+(6*constantesMix.getbm()*constantesMix.getcm())+(bpj*constantesMix.getbm())+(3*bpj*constantesMix.getcm())+(3*constantesMix.getbm()*cpj)+(constantesMix.getcm()*cpj)))
                ...
                + ((D1_l/QQ)*(constantesMix.getbm()*bpj)+(3*constantesMix.getbm()*cpi)- (Math.pow(constantesMix.getbm(),2)) + (3*bpj*constantesMix.getcm())+(constantesMix.getcm()*cpj)-(Math.pow(constantesMix.getcm(),2))-(6*constantesMix.getbm()*constantesMix.getcm())));
        
        
        //phil_i=(exp((log(vml/(vml-bm)))+((bm+bpi)/(vml-bm))+((api*D1_l)/(R*T))+((am/(R*T))*F1l_i)-log(Zlm)))*zi*P;
        phil_i = (Math.exp((Math.log(vml/(vml-constantesMix.getbm()))))+((constantesMix.getbm()+bpi)/(vml-constantesMix.getbm()))+((api*D1_l)/(constantes.getR()*T))+(((constantesMix.getam()/(constantes.getR()*T))*F1l_i)-Math.log(zetamix.getZlm())))*zi*P;
        
        //phiv_i=(exp((log(vmv/(vmv-bm)))+((bm+bpi)/(vmv-bm))+((api*D1_v)/(R*T))+((am/(R*T))*F1v_i)-log(Zvm)))*zi*P;
        phiv_i = (Math.exp((Math.log(vmv/(vmv-constantesMix.getbm()))))+((constantesMix.getbm()+bpi)/(vmv-constantesMix.getbm()))+((api*D1_v)/(constantes.getR()*T))+(((constantesMix.getam()/(constantes.getR()*T))*F1v_i)-Math.log(zetamix.getZvm())))*zi*P;

        //phil_j=(exp((log(vml/(vml-bm)))+((bm+bpj)/(vml-bm))+((apj*D1_l)/(R*T))+((am/(R*T))*F1l_j)-log(Zlm)))*(1-zi)*P;
        phil_j = (Math.exp((Math.log(vml/(vml-constantesMix.getbm()))))+((constantesMix.getbm()+bpj)/(vml-constantesMix.getbm()))+((apj*D1_l)/(constantes.getR()*T))+(((constantesMix.getam()/(constantes.getR()*T))*F1l_j)-Math.log(zetamix.getZlm())))*zi*P;

        //phiv_j=(exp((log(vmv/(vmv-bm)))+((bm+bpj)/(vmv-bm))+((apj*D1_v)/(R*T))+((am/(R*T))*F1v_j)-log(Zvm)))*(1-zi)*P;
        phiv_j = (Math.exp((Math.log(vmv/(vmv-constantesMix.getbm()))))+((constantesMix.getbm()+bpj)/(vmv-constantesMix.getbm()))+((apj*D1_v)/(constantes.getR()*T))+(((constantesMix.getam()/(constantes.getR()*T))*F1v_j)-Math.log(zetamix.getZvm())))*zi*P;
