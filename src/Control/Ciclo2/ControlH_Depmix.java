...
public class ControlH_Depmix {
    ...
    public ControlH_Depmix(double T, double P, double zi){
        ...
        HDV=(constantesMix.getConstantes().getR()*T*(zeta.getZv()-1)-((T*dadt_mix.getDa_dT_mix())-constantesMix.getam())*((1/(2*constantesMix.getNm()))*(Math.log((zeta.getZl()+constantesMix.getMm())/(zeta.getZv()+constantesMix.getQm())))))*100000;
