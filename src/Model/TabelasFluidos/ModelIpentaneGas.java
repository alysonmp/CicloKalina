 ...
 */
@Entity
@Table(name = "ipentane_gas")
public class ModelIpentaneGas implements Serializable{
    @Id
    @GeneratedValue
    private int ID;
    ...
    public ModelIpentaneGas() {
    }

    public ModelIpentaneGas(double pressao, double temperatura, double kv, double Cpv, double Prv, double Muv) {
