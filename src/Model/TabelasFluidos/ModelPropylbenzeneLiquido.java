 ...
 */
@Entity
@Table(name = "propylbenzene_liquido")
public class ModelPropylbenzeneLiquido implements Serializable{
    ...
    public ModelPropylbenzeneLiquido(double pressao, double temperatura, double Cpl, double Prl, double kl, double Mul, double Vcl) {
